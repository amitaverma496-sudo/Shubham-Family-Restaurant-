...
export default function App() {
  ...
  return (
    <div ref={containerRef} onMouseMove={handleMouseMove} className="selection:bg-gold selection:text-black min-h-screen bg-lux-black relative">
      ...
      {/* GOOGLE SIGN-IN INTERACTIVE ACCESS GATE OVERLAY */}
      <AnimatePresence>
        {showSignInGate && (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <p className="text-xs text-white/60 tracking-wider leading-relaxed font-sans max-w-sm mx-auto">
                  To protect reservation databases, verify table bookings, and grant executive suite clearance, please verify your identity via secure Google Sign-In.
                </p>

                {/* Tactile Luxe Google Auth Button */}
                <button
                  id="google-signin-btn"
                  onClick={handleSignInGoogle}
                  className="w-full h-12 rounded-full bg-white text-black font-semibold text-xs tracking-wider uppercase transition-all duration-300 hover:bg-gold hover:text-black flex items-center justify-center gap-3 shadow-[0_4px_20px_rgba(255,255,255,0.05)] hover:shadow-[0_4px_25px_rgba(212,175,55,0.25)] active:scale-[0.98] cursor-pointer"
                >
