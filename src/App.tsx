...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Update cached rect of hero section on scroll to avoid thrashing during mousemove
      if (heroRef.current) {
        heroRectRef.current = heroRef.current.getBoundingClientRect();
      }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div className="space-y-8 text-left">
                    ...
                    <div className="glass p-6 rounded-3xl border border-white/8 space-y-4">
                      ...
                      <form onSubmit={(e) => { e.preventDefault(); handleAddInquiry(e); }} className="space-y-4 text-xs">
